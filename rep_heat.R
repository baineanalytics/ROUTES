...
png(file = "rep_heat600.png", units="in", width=11, height=6, res=600)
...
gg <- gg + geom_map(map = world_map, aes(map_id = country, fill = sum), color = "gray20", lwd = .05) + 
  scale_fill_distiller(palette = "Greens", name="Reptiles", na.value = "gray87", direction = 1) + 
...
png(file = "rep_trans.png", units="in", width=11, height=8.5, res=300)
