...
png(file = "uptot_seiz_counts.png", units="in", width=5, height=4, res=300)
...
png(file = "uptot_info_quality.png", units="in", width=5, height=4, res=300)
...
png(file = "uptot_risk.png", units="in", width=11, height=8.5, res=300)
